...
_HAYSTACK_MSG = "geoHaystack indexes are deprecated as of MongoDB 4.4." " Instead, create a 2d index and use $geoNear or $geoWithin." " See https://dochub.mongodb.org/core/4.4-deprecate-geoHaystack"
...
class Collection(common.BaseObject):
    """A Mongo collection.
    """
    def __init__(self, database, name, create=..., codec_options=..., read_preference=..., write_concern=..., read_concern=..., session=..., **kwargs) -> None:
    ...
    def initialize_unordered_bulk_op(self, bypass_document_validation=...):
    ...
    def initialize_ordered_bulk_op(self, bypass_document_validation=...):
    ...
    def bulk_write(self, requests, ordered=..., bypass_document_validation=..., session=...):
    ...
    def insert_many(self, documents, ordered=..., bypass_document_validation=..., session=...):
    ...
    def replace_one(self, filter, replacement, upsert=..., bypass_document_validation=..., collation=..., hint=..., session=...):
    ...
    def update_one(self, filter, update, upsert=..., bypass_document_validation=..., collation=..., array_filters=..., hint=..., session=...):
    ...
    def update_many(self, filter, update, upsert=..., array_filters=..., bypass_document_validation=..., collation=..., hint=..., session=...):
    ...
    def delete_one(self, filter, collation=..., hint=..., session=...):
    ...
    def delete_many(self, filter, collation=..., hint=..., session=...):
    ...
    def parallel_scan(self, num_cursors, session=..., **kwargs):
    ...
    def count_documents(self, filter, session=..., **kwargs):
    ...
    def count(self, filter=..., session=..., **kwargs):
    ...
    def create_indexes(self, indexes, session=..., **kwargs):
    ...
    def create_index(self, keys, session=..., **kwargs):
    ...
    def drop_indexes(self, session=..., **kwargs):
    ...
    def drop_index(self, index_or_name, session=..., **kwargs):
    ...
    def reindex(self, session=..., **kwargs):
    ...
    def index_information(self, session=...):
    ...
    def group(self, key, condition, initial, reduce, finalize=..., **kwargs):
    ...
    def rename(self, new_name, session=..., **kwargs):
    ...
    def distinct(self, key, filter=..., session=..., **kwargs):
    ...
    def map_reduce(self, map, reduce, out, full_response=..., session=..., **kwargs):
    ...
    def inline_map_reduce(self, map, reduce, full_response=..., session=..., **kwargs):
    ...
    def find_one_and_delete(self, filter, projection=..., sort=..., hint=..., session=..., **kwargs):
    ...
    def find_one_and_replace(self, filter, replacement, projection=..., sort=..., upsert=..., return_document=..., hint=..., session=..., **kwargs):
    ...
    def find_one_and_update(self, filter, update, projection=..., sort=..., upsert=..., return_document=..., array_filters=..., hint=..., session=..., **kwargs):
    ...
    def save(self, to_save, manipulate=..., check_keys=..., **kwargs):
    ...
    def insert(self, doc_or_docs, manipulate=..., check_keys=..., continue_on_error=..., **kwargs):
    ...
    def update(self, spec, document, upsert=..., manipulate=..., multi=..., check_keys=..., **kwargs):
    ...
    def remove(self, spec_or_id=..., multi=..., **kwargs):
    ...
    def find_and_modify(self, query=..., update=..., upsert=..., sort=..., full_response=..., manipulate=..., **kwargs):
